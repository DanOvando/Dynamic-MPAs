...
lh$Nmsy<- -999
lh$MaxAge <- 30 
lh$m <- rep(0.15,lh$MaxAge)  # blaber et al estimate  Z= .11    so i cut this in half for m???
...
lh$BH.Steepness<- 0.8 #Beverton-holt steepness parameter, taken in this case from assessments fro starry flounder and dover sole, all of which have steepness 0.8

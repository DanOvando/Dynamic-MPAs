...
lh$Nmsy<- -999
lh$MaxAge <- 34 
lh$m <- rep(0.29,lh$MaxAge)  # blaber et al estimate  Z= .11    so i cut this in half for m???
...
lh$BH.Steepness<- 0.7 #Beverton-holt steepness parameter, guessing similar to red snapper

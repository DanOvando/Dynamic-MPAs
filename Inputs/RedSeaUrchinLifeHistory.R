...
lh$Nmsy<- -999
lh$MaxAge <- 50 
lh$m <- rep(0.08,lh$MaxAge)  # blaber et al estimate  Z= .11    so i cut this in half for m???
...
lh$BH.Steepness<- 0.25 #Beverton-holt steepness parameter, no idea here, making it really low just to have one low one
